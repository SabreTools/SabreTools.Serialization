...
namespace SabreTools.Data.Extensions.Test
{
    public class TypeLengthValueTests
    {
        ...
        public void Format_InvalidConstructed()
        {
            ...
            var tlv = new TypeLengthValue { Type = ASN1Type.V_ASN1_OBJECT | ASN1Type.V_ASN1_CONSTRUCTED, Length = 1, Value = false };
            string actual = tlv.Format();
            Assert.Equal(expected, actual);
        }
        ...
        public void Format_InvalidDataType()
        {
            ...
            var tlv = new TypeLengthValue { Type = ASN1Type.V_ASN1_OBJECT, Length = 1, Value = false };
            string actual = tlv.Format();
            Assert.Equal(expected, actual);
        }
