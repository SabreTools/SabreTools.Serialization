...
{
    public partial class XZP : WrapperBase<Data.Models.XZP.File>
    {
        ...
        /// <inheritdoc/>
        public XZP(Data.Models.XZP.File model, byte[] data) : base(model, data) { }

        /// <inheritdoc/>
        public XZP(Data.Models.XZP.File model, byte[] data, int offset) : base(model, data, offset) { }

        /// <inheritdoc/>
        public XZP(Data.Models.XZP.File model, byte[] data, int offset, int length) : base(model, data, offset, length) { }

        /// <inheritdoc/>
        public XZP(Data.Models.XZP.File model, Stream data) : base(model, data) { }

        /// <inheritdoc/>
        public XZP(Data.Models.XZP.File model, Stream data, long offset) : base(model, data, offset) { }

        /// <inheritdoc/>
        public XZP(Data.Models.XZP.File model, Stream data, long offset, long length) : base(model, data, offset, length) { }
        ...
        public static XZP? Create(Stream? data)
        {
            ...
            try
            {
                ...
                var model = new Serialization.Readers.XZP().Deserialize(data);
                if (model is null)
                    return null;
