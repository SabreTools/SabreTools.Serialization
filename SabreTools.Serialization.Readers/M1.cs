...
{
    public class M1 : BaseBinaryReader<Data.Models.Listxml.M1>
    {
        /// <inheritdoc/>
        public override Data.Models.Listxml.M1? Deserialize(Stream? data)
        {
            ...
            try
            {
                ...
                Data.Models.Listxml.M1? m1 = null;
                while (reader.Read())
                {
        ...
        /// <summary>
        /// Parse from an XmlTextReader into a M1
        /// </summary>
        /// <param name="reader">XmlTextReader to read from</param>
        /// <returns>Filled M1 on success, null on error</returns>
        public Data.Models.Listxml.M1 ParseM1(XmlTextReader reader)
        {
            var obj = new Data.Models.Listxml.M1();
