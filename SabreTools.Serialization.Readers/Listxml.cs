...
{
    public class Listxml : BaseBinaryReader<Mame>
    {
        /// <inheritdoc/>
        public override Mame? Deserialize(Stream? data)
        {
        ...
        /// <summary>
        /// Parse from an XmlTextReader into a Mame
        /// </summary>
        /// <param name="reader">XmlTextReader to read from</param>
        /// <returns>Filled Mame on success, null on error</returns>
        public Mame ParseMame(XmlTextReader reader)
        {
            var obj = new Mame();
