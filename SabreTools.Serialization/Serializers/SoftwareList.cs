...
{
    public class SoftwareList : XmlFile<SabreTools.Serialization.Models.SoftwareList.SoftwareList>
    {
        #region Constants
        ...
        public override bool SerializeFile(SabreTools.Serialization.Models.SoftwareList.SoftwareList? obj, string? path)
        ...
        public override Stream? SerializeStream(SabreTools.Serialization.Models.SoftwareList.SoftwareList? obj)
