...
{
    public class WAD3 : BaseBinaryDeserializer<SabreTools.Models.WAD3.File>
    {
        /// <inheritdoc/>
        public override SabreTools.Models.WAD3.File? Deserialize(Stream? data)
        {
            ...
            try
            {
                ...
                var file = new SabreTools.Models.WAD3.File();
