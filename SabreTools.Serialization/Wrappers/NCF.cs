...
namespace SabreTools.Serialization.Wrappers
{
    public partial class NCF : WrapperBase<Data.Models.NCF.File>
    {
        ...
        /// <inheritdoc/>
        public NCF(Data.Models.NCF.File model, byte[] data) : base(model, data) { }

        /// <inheritdoc/>
        public NCF(Data.Models.NCF.File model, byte[] data, int offset) : base(model, data, offset) { }

        /// <inheritdoc/>
        public NCF(Data.Models.NCF.File model, byte[] data, int offset, int length) : base(model, data, offset, length) { }

        /// <inheritdoc/>
        public NCF(Data.Models.NCF.File model, Stream data) : base(model, data) { }

        /// <inheritdoc/>
        public NCF(Data.Models.NCF.File model, Stream data, long offset) : base(model, data, offset) { }

        /// <inheritdoc/>
        public NCF(Data.Models.NCF.File model, Stream data, long offset, long length) : base(model, data, offset, length) { }
