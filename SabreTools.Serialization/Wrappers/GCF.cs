...
{
    public partial class GCF : WrapperBase<SabreTools.Models.GCF.File>
    {
...
#if NET20 || NET35
                    if ((directoryEntry.DirectoryFlags & SabreTools.Models.GCF.HL_GCF_FLAG.HL_GCF_FLAG_FILE) == 0)
#else
...
#if NET20 || NET35
                        Encrypted = (directoryEntry.DirectoryFlags & SabreTools.Models.GCF.HL_GCF_FLAG.HL_GCF_FLAG_ENCRYPTED) != 0,
#else
        ...
        /// <inheritdoc/>
        public GCF(SabreTools.Models.GCF.File model, byte[] data) : base(model, data) { }

        /// <inheritdoc/>
        public GCF(SabreTools.Models.GCF.File model, byte[] data, int offset) : base(model, data, offset) { }

        /// <inheritdoc/>
        public GCF(SabreTools.Models.GCF.File model, byte[] data, int offset, int length) : base(model, data, offset, length) { }

        /// <inheritdoc/>
        public GCF(SabreTools.Models.GCF.File model, Stream data) : base(model, data) { }

        /// <inheritdoc/>
        public GCF(SabreTools.Models.GCF.File model, Stream data, long offset) : base(model, data, offset) { }

        /// <inheritdoc/>
        public GCF(SabreTools.Models.GCF.File model, Stream data, long offset, long length) : base(model, data, offset, length) { }
