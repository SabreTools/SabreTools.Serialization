            ...
            try
            {
                ...
                foreach (var kvp in resourceData)
                {
                    ...
                    for (; resourceOffset < 0x400 && resourceOffset < ba.Length - 0x10; resourceOffset++)
                    {
                        ...
                        if (resourceSample.StartsWith(SabreTools.Models.SevenZip.Constants.SignatureBytes))
                        {
                            extension = "7z";
                            break;
                        }
                        ...
                        else if (resourceSample.StartsWith(SabreTools.Models.BZip2.Constants.SignatureBytes))
                        {
                            extension = "bz2";
                            break;
                        }
                        ...
                        else if (resourceSample.StartsWith(SabreTools.Models.RAR.Constants.OldSignatureBytes))
                        {
                            extension = "rar";
                            break;
                        }
                        ...
                        else if (resourceSample.StartsWith(SabreTools.Models.XZ.Constants.SignatureBytes))
                        {
                            extension = "xz";
                            break;
                        }
